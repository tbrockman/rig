...
// schemaJSON is rig.yaml's JSON Schema, generated by `make generate`. Kept
// apart from assets, which holds only what gets written out as a tree.
//
//go:embed schema/rig.schema.json
var schemaJSON []byte

// Schema is rig.yaml's JSON Schema.
